...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\bquantity\x18\x01 \x01(\x05R\bquantity2Q\n" +
	"\x10InventoryService\x12=\n" +
	"\bGetStock\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponseB\x11Z\x0f./gen;inventoryb\x06proto3"
...
var file_proto_inventory_proto_depIdxs = []int32{
	0, // 0: inventory.InventoryService.GetStock:input_type -> inventory.StockRequest
	1, // 1: inventory.InventoryService.GetStock:output_type -> inventory.StockResponse
